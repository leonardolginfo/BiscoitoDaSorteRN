...
export default function App() {
  const[img,setImg]=useState(require('./assets/bisc/biscoito.png'));
  ...
  function quebrarBiscoito(){
    let sortearFrase = Math.floor(Math.random() * frases.length)
    setFrase(frases[sortearFrase]); 
    setImg(require('./assets/bisc/biscoitoAberto.png'))
  }

  function reiniciar(){
    setFrase('');
    setImg(require('./assets/bisc/biscoito.png'))
  }
  ...
  return (
    ...
    style={styles.img}
      ...
      <TouchableOpacity style={styles.btnQuebrar} onPress={quebrarBiscoito}>
          <View style={styles.btnArea}>
            <Text style={styles.btnTextQuebrar}>Quebrar biscoito</Text>
          </View>
      </TouchableOpacity>

      <TouchableOpacity style={[styles.btnQuebrar, {marginTop:15, borderColor:'#121212'}]} onPress={reiniciar}>
          <View style={styles.btnArea}>
            <Text style={[styles.btnTextQuebrar, {color:'#121212'}]}>Reiniciar Biscoito</Text>
          </View>
      </TouchableOpacity>
